...
| O15 | O | Retired as a work lane. Orchestration is the role of the zero element O0. |
...
- O0 orchestration: cross-repo local orchestration, packaging the program across the site, the manuscripts and the public demos.
...
- O16 publication: the exploratory findings manuscript chain, presentation and funding coordination.
